...
public final class Program implements Comparable<Program> {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(TvContract.Programs.COLUMN_DROIDLOGIC_IS_APPOINTED, mIsAppointed ? 1 : 0);
        return values;
    }
    ...
    public static Program fromCursor(Cursor cursor) {
        ...
        index = cursor.getColumnIndex(TvContract.Programs.COLUMN_DROIDLOGIC_IS_APPOINTED);
        if (index >= 0) {
