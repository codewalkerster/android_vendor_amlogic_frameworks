...
public interface TvControlCommand {
    ...
    int FACTORY_GETGLOBALOGO_RGAIN = 282;
    int FACTORY_GETGLOBALOGO_GGAIN = 283;
    int FACTORY_GETGLOBALOGO_BGAIN = 284;
    int FACTORY_GETGLOBALOGO_ROFFSET = 285;
    int FACTORY_GETGLOBALOGO_GOFFSET = 286;
    int FACTORY_GETGLOBALOGO_BOFFSET = 287;
    int FACTORY_SETGLOBALOGO_RGAIN = 288;
    int FACTORY_SETGLOBALOGO_GGAIN = 289;
    int FACTORY_SETGLOBALOGO_BGAIN = 290;
    int FACTORY_SETGLOBALOGO_ROFFSET = 291;
    int FACTORY_SETGLOBALOGO_GOFFSET = 292;
    int FACTORY_SETGLOBALOGO_BOFFSET = 293;
    int FACTORY_CLEAN_ALL_TABLE_FOR_PROGRAM = 294;
    int FACTORY_GETADBD_STATUS = 295;
    int FACTORY_SETADBD_SWITCH = 296;
    ...
    int SET_AMAUDIO_REV1 = 379;
    int SET_AMAUDIO_REV2 = 380;
    int SET_AMAUDIO_REV3 = 381;
    ...
    int SSM_SAVE_PROJECT_ID = 673;
    int SSM_READ_PROJECT_ID = 674;
    ...
    // Misc
    int MISC_PROP_SET = 701;
    int MISC_PROP_GET = 702;
    ...
    int MISC_SET_I2C_BUS_STATUS = 711;
    int MISC_GET_I2C_BUS_STATUS = 712;
    int MISC_GET_TV_API_VERSION = 713;
    int MISC_GET_DVB_API_VERSION = 714;
    int MISC_SERIAL_SWITCH = 715;
    int MISC_SERIAL_SEND_DATA = 716;
    int MISC_SET_POWER_LED_INDICATOR = 719;
    int MISC_SET_PANEL_MUTE = 720;
    int MISC_CHANNEL_EXPORT = 721;
    int MISC_CHANNEL_IMPORT = 722;
    int MISC_GET_PROJECT_INFO = 723;
    int MISC_GET_PLATFORM_TYPE = 724;

    //Extra
    int FORMAT_PARTITION = 801;
    int DELETE_DIR_FILES = 802;
    int REQUEST_RESOURCES = 803;
    int RELEASED_RESOURCES = 804;
    int SET_LISTEN_TO_RESOURCE = 805;
    int QUERY_RESOURCE_STATE = 806;
    int GET_DISPLAY_RESOLUTION_CONFIG = 808;
    int GET_DISPLAY_RESOLUTION_INFO = 809;
    int HDMIRX_CEC_SEND_CUSTOM_MESSAGE = 810;
    int HDMIRX_CEC_SEND_CUSTOM_WAIT_REPLY_MESSAGE = 811;
    int HDMIRX_CEC_SEND_BROADCAST_STANDBY_MESSAGE = 812;
    int HDMIRX_CEC_SEND_GIVE_CEC_VERSION_MESSAGE = 813;
    int HDMIRX_CEC_SEND_GIVE_DEV_VENDOR_ID_MESSAGE = 814;
    int HDMIRX_CEC_SEND_GIVE_OSD_NAME_MESSAGE = 815;
    int HDMIRX_GET_KSV_INFO = 816;
    ...
    int FACTORY_FBC_SEND_KEY_TO_FBC = 939;
    int FACTORY_FBC_POWER_REBOOT = 940;
    int FACTORY_FBC_GET_ELEC_MODE = 941;
    int FACTORY_FBC_PANEL_USER_SETTING_DEFAULT = 942;
    int FACTORY_FBC_SET_BACKLIFHT_N360 = 943;
    int FACTORY_FBC_GET_BACKLIFHT_N360 = 944;
    ...
    // atsc
    int TV_AUTO_SCAN = 1460;
    int TV_SET_SCAN_SOURCE = 1461;
    int TV_GET_SCAN_SOURCE = 1462;
    int TV_GET_DTV_SCAN_SOURCE = 1463;
    int TV_SET_ATSC_ATTENNA_TYPE = 1464;
    int TV_GET_ATSC_ATTENNA_TYPE = 1465;
    int TV_GET_CURRENT_PROGRAM_TYPE = 1466;

    //vchip
    int DTV_SET_VCHIP_LOCKSTATUS = 1432;
    int DTV_GET_VCHIP_LOCKSTATUS = 1433;
    int DTV_SET_VCHIP_UNBLOCK = 1434;
    int DTV_GET_CURRENT_VCHIP_BLOCK  =1435;
    int DTV_SET_VCHIP_BLOCK_ON_OFF=1436;

    int TV_SET_SOUND_TRACK_MODE = 1437;
    int TV_GET_SOUND_TRACK_MODE = 1438;

    int SET_LEFT_RIGHT_SOUND_CHANNEL = 1439;
    int GET_LEFT_RIGHT_SOUND_CHANNEL = 1440;

    int GET_AVERAGE_LUMA = 1480;
    int GET_AUTO_BACKLIGHT_DATA = 1481;
    int SET_AUTO_BACKLIGHT_DATA = 1482;

    int GET_HISTGRAM = 2000;
    int GET_HISTGRAM_AVE = 2001;
    int SET_SCREEN_COLOR = 2002;
    int FAC_PLAY_DTV_PROGRAM = 2003;
    int FAC_PLAY_ATV_PROGRAM = 2004;
    int FAC_PLAY_DTV_PROGRAM01 = 2005;

    //factory copy file
    int FACTORY_COPY_FILE = 2100;

    //customer interface
    int FACTROY_FBC_SET_LIGHT_SENSOR_STATUS_N310 = 3000;
    int FACTROY_FBC_GET_LIGHT_SENSOR_STATUS_N310 = 3001;
    int FACTROY_FBC_SET_DREAM_PANEL_STATUS_N310 = 3002;
    int FACTROY_FBC_GET_DREAM_PANEL_STATUS_N310 = 3003;
    int SSM_EEPROM_SAVE_ONE_BYTE_N310_N311 = 3004;
    int SSM_EEPROM_READ_ONE_BYTE_N310_N311 = 3005;
    int SSM_EEPROM_SAVE_N_BYTES_N310_N311 = 3006;
    int SSM_EEPROM_READ_N_BYTES_N310_N311 = 3007;
    int SSM_FLASH_SAVE_ONE_BYTE_N310_N311 = 3008;
    int SSM_FLASH_READ_ONE_BYTE_N310_N311 = 3009;
    int SSM_FLASH_SAVE_N_BYTES_N310_N311 = 3010;
    int SSM_FLASH_READ_N_BYTES_N310_N311 = 3011;
    int FACTROY_FBC_SET_MULT_PQ_STATUS_N310 = 3012;
    int FACTROY_FBC_GET_MULT_PQ_STATUS_N310 = 3013;
    int FACTROY_FBC_SET_MEMC_STATUS_N310 = 3014;
    int FACTROY_FBC_GET_MEMC_STATUS_N310 = 3015;
