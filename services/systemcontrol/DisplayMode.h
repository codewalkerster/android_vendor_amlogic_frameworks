...
enum {
    ...
    DISPLAY_MODE_480X320P60HZ		= 21,
    DISPLAY_MODE_640X480P60HZ		= 22,
    DISPLAY_MODE_800X600P60HZ		= 23,
    DISPLAY_MODE_800X480P60HZ		= 24,
    DISPLAY_MODE_1024X600P60HZ		= 25,
    DISPLAY_MODE_1024X768P60HZ		= 26,
    DISPLAY_MODE_1280X800P60HZ		= 27,
    DISPLAY_MODE_1280X1024P60HZ		= 28,
    DISPLAY_MODE_1360X768P60HZ		= 29,
    DISPLAY_MODE_1366X768P60HZ		= 30,
    DISPLAY_MODE_1440X900P60HZ		= 31,
    DISPLAY_MODE_1600X900P60HZ		= 32,
    DISPLAY_MODE_1600X1200P60HZ		= 33,
    DISPLAY_MODE_1680X1050P60HZ		= 34,
    DISPLAY_MODE_1920X1200P60HZ		= 35,
    DISPLAY_MODE_2560X1440P60HZ		= 36,
    DISPLAY_MODE_2560X1600P60HZ		= 37,
    DISPLAY_MODE_2560X1080P60HZ		= 38,
    DISPLAY_MODE_3440X1440P60HZ		= 39,
    DISPLAY_MODE_CUSTOMBUILT		= 40,
    DISPLAY_MODE_TOTAL                  = 41
};
